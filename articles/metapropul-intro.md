...
Subgroup analysis is opt-in. All core functions default to
`subgroup = NULL`, and the GUI displays **None** even when the uploaded
or bundled dataset contains a possible subgroup column. This prevents an
unintended subgroup model from being fitted simply because such a column
exists.
